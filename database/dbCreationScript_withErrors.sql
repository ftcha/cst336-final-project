...
(NULL, 19.66, 0.79, 7.95, 'tom.riddle'),
(NULL, 193.76, 10.85, 7.95, 'ludo.bagman'),
(NULL, 34.74, 1.01, 7.95, 'fleur.delacour'),
(NULL, 6.38, 0.67, 7.95, 'lee.jordan'),
(NULL, 1.4, 0.08, 7.95, 'gilderoy.lockhart'),
(NULL, 19.37, 0.92, 7.95, 'padma.patil'),
(NULL, 44.4, 1.78, 7.95, 'kingsley.shacklebolt'),
(NULL, 5.69, 0.37, 7.95, 'dolores.umbridge'),
(NULL, 34.76, 1.91, 7.95, 'oliver.wood'),
(NULL, 20.63, 1.24, 7.95, 'buckbeak'),
(NULL, 9.07, 0.57, 7.95, 'draco.malfoy'),
(NULL, 21.36, 1.36, 7.95, 'neville.longbottom'),
(NULL, 28.58, 1.71, 7.95, 'rubeus.hagrid'),
(NULL, 6.38, 0.29, 7.95, 'norbert'),
(NULL, 37.99, 1.9, 7.95, 'aurora.sinistra'),
(NULL, 24.75, 0.99, 7.95, 'hermione.granger'),
(NULL, 31.84, 1.27, 7.95, 'cedric.diggory'),
(NULL, 16.69, 0.83, 7.95, 'sirius.black'),
(NULL, 7.95, 0.52, 7.95, 'dennis.creevey'),
(NULL, 13.89, 0.56, 7.95, 'viktor.krum');


INSERT INTO transactionDetails (tranId, lineNumber, productId) VALUES
( (SELECT tranId FROM TRANSACTION WHERE userId='tom.riddle'), NULL, 3),
( (SELECT tranId FROM TRANSACTION WHERE userId='tom.riddle'), NULL, 18),
( (SELECT tranId FROM TRANSACTION WHERE userId='tom.riddle'), NULL, 7),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 1),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 2),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 3),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 4),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 5),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 6),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 7),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 8),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 9),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 10),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 11),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 12),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 13),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 14),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 15),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 16),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 17),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 18),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 19),
( (SELECT tranId FROM TRANSACTION WHERE userId='ludo.bagman'), NULL, 20),
( (SELECT tranId FROM TRANSACTION WHERE userId='fleur.delacour'), NULL, 4),
( (SELECT tranId FROM TRANSACTION WHERE userId='fleur.delacour'), NULL, 6),
( (SELECT tranId FROM TRANSACTION WHERE userId='fleur.delacour'), NULL, 10),
( (SELECT tranId FROM TRANSACTION WHERE userId='fleur.delacour'), NULL, 9),
( (SELECT tranId FROM TRANSACTION WHERE userId='lee.jordan'), NULL, 3),
( (SELECT tranId FROM TRANSACTION WHERE userId='gilderoy.lockhart'), NULL, 16),
( (SELECT tranId FROM TRANSACTION WHERE userId='padma.patil'), NULL, 11),
( (SELECT tranId FROM TRANSACTION WHERE userId='padma.patil'), NULL, 8),
( (SELECT tranId FROM TRANSACTION WHERE userId='padma.patil'), NULL, 1);
